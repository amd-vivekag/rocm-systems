...
/// @param[out] exec Handle to the newly created executable (refcount = 1).
...
/// @details Increments the reference count on the returned code object.
/// @param[in] exec The executable containing the code object.
/// @param[in] target Target architecture to filter by.
/// @param[in] index Index of the code object for that target.
/// @param[out] obj Handle to the code object (caller must release when done).
/// @returns ROCJITSU_STATUS_SUCCESS on success.
...
/// @param[in] target_id Target architecture for decoding.
/// @param[out] list Handle to the newly created basic block list (refcount = 1).
/// @returns ROCJITSU_STATUS_SUCCESS on success.
...
/// @details Increments the reference count on the returned block.
/// @param[in] list Basic block list to index into.
/// @param[in] index Zero-based index of the basic block.
/// @param[out] block Handle to the basic block (caller must release when done).
/// @returns ROCJITSU_STATUS_SUCCESS on success.
