...
void VExpLegacyF32Vop1::execute(amdgpu::Wavefront &wf) { (void)wf; }
...
void VLogLegacyF32Vop1::execute(amdgpu::Wavefront &wf) { (void)wf; }
...
void VPrngB32Vop1::execute(amdgpu::Wavefront &wf) { (void)wf; }
...
void VPermlane16SwapB32Vop1::execute(amdgpu::Wavefront &wf) { (void)wf; }
...
void VPermlane32SwapB32Vop1::execute(amdgpu::Wavefront &wf) { (void)wf; }
...
void VCvtF32Bf16Vop1::execute(amdgpu::Wavefront &wf) { (void)wf; }
