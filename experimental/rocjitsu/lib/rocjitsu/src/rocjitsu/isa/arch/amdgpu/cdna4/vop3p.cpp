...
void VDot2F32Bf16Vop3p::execute(amdgpu::Wavefront &wf) { (void)wf; }
...
void VPkMinimum3F16Vop3p::execute(amdgpu::Wavefront &wf) { (void)wf; }
...
void VPkMaximum3F16Vop3p::execute(amdgpu::Wavefront &wf) { (void)wf; }
