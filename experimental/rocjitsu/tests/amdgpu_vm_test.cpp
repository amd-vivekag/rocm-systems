...
constexpr uint32_t s_and_b32(uint32_t sdst, uint32_t s0, uint32_t s1) {
  return sop2(12, sdst, s0, s1);
}
constexpr uint32_t s_mul_i32(uint32_t sdst, uint32_t s0, uint32_t s1) {
  return sop2(36, sdst, s0, s1);
}
...
constexpr uint32_t s_cmp_lt_i32(uint32_t s0, uint32_t s1) { return sopc(4, s0, s1); }
